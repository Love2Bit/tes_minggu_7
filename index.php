      ...
      <tbody>
          <?php foreach ($data_siswa as $key):?>
              <tr>
                  ...
                  <td><a class="btn btn-danger" data-toggle="modal" data-target="#siswa"><i class="fas fa-user-times"></i></a> | <a class="btn btn-warning" href="edit.php?id_siswa=<?php echo $key['id_siswa']; ?>"><i class="fas fa-user-edit"></i></a></td>
              </tr>
  <?php endforeach; ?>
      </tbody>
  </table>
